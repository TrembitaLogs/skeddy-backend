...
def resolve_ride_timezone(timezone_str: str) -> tuple[ZoneInfo, bool]:
    """Parse timezone string, falling back to UTC.

    Returns:
        Tuple of (ZoneInfo, fallback_used).
    """
    try:
        return ZoneInfo(timezone_str), False
